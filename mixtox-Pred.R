...
plot(x_AC5mn,as.matrix(y_AC5mn), log = "x", pch = 19, 
     main = "AC50 min", ylim = rsp_rng, xlim = range(ca_AC5mn, ia_AC5mn, x_AC5mn),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_AC5mn, EffPoints, lwd = 1.5, col = 2)
lines(ia_AC5mn, EffPoints, lwd = 1.5, col = 3)

plot(x_AC5mx,as.matrix(y_AC5mx), log = "x", pch = 19, 
     main = "AC50 max", ylim = rsp_rng, xlim = range(ca_AC5mx, ia_AC5mx, x_AC5mx),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_AC5mx, EffPoints, lwd = 1.5, col = 2)
lines(ia_AC5mx, EffPoints, lwd = 1.5, col = 3)

plot(x_Expmn, as.matrix(y_Expmn), log = "x", pch = 19, 
     main = "Expo min", ylim = rsp_rng, xlim = range(ca_Expmn, ia_Expmn, x_Expmn),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_Expmn, EffPoints, lwd = 1.5, col = 2)
lines(ia_Expmn, EffPoints, lwd = 1.5, col = 3)

plot(x_Expmx, as.matrix(y_Expmx), log = "x", pch = 19, 
     main = "Expo max", ylim = rsp_rng, xlim = range(ca_Expmx, ia_Expmx, x_Expmx),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_Expmx, EffPoints, lwd = 1.5, col = 2)
lines(ia_Expmx, EffPoints, lwd = 1.5, col = 3)

plot(x_PODmn,as.matrix(y_PODmn), log = "x", pch = 19, 
     main = "POD min", ylim = rsp_rng, xlim = range(ca_PODmn, ia_PODmn, x_PODmn),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_PODmn, EffPoints, lwd = 1.5, col = 2)
lines(ia_PODmn, EffPoints, lwd = 1.5, col = 3)

plot(x_PODmx,as.matrix(y_PODmx), log = "x", pch = 19, 
     main = "POD max", ylim = rsp_rng, xlim = range(ca_PODmx, ia_PODmx, x_PODmx),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_PODmx, EffPoints, lwd = 1.5, col = 2)
lines(ia_PODmx, EffPoints, lwd = 1.5, col = 3)

plot(x_RfDmn,as.matrix(y_RfDmn), log = "x", pch = 19, 
     main = "RfD min", ylim = rsp_rng, xlim = range(ca_RfDmn, ia_RfDmn, x_RfDmn),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_RfDmn, EffPoints, lwd = 1.5, col = 2)
lines(ia_RfDmn, EffPoints, lwd = 1.5, col = 3)

plot(x_RfDmx,as.matrix(y_RfDmx), log = "x", pch = 19, 
     main = "RfD max", ylim = rsp_rng, xlim = range(ca_RfDmx, ia_RfDmx, x_RfDmx),
     xlab = expression(paste("Concentration (", mu,"M)")), ylab = "Inhibition (%)")
lines(ca_RfDmx, EffPoints, lwd = 1.5, col = 2)
lines(ia_RfDmx, EffPoints, lwd = 1.5, col = 3)
